...
document.querySelector(".tombol").addEventListener('click', function () {
	Swal.fire({
    	...
    	Swal.fire({
    		...
    		Swal.fire({
				title: '',
    			html: `Terimakasih loh selalu meluangkan waktu untukku`,
    			timer: 2700,
    			timerProgressBar: true,
    			showConfirmButton: false}).then((result) => {
    			...
    			Swal.fire({
					title: '',
    				html: `Juga selalu mau direpotin tengah malem 🥺`,
    				timer: 2700,
    				timerProgressBar: true,
    				showConfirmButton: false}).then((result) => {
    				...
    				Swal.fire({
						title: '',
    					html: `Maaf ya kalau aku rewel terus 🥺`,
    					timer: 2700,
    					timerProgressBar: true,
    					showConfirmButton: false}).then((result) => {
    					...
    					Swal.fire({
    						...
    						Swal.fire({
								title: '',
    							html: `Semoga Kasih Sayang Tuhan selalu tercurahkan untukmu`,
    							timer: 2700,
    							timerProgressBar: true,
    							showConfirmButton: false}).then((result) => {
    							...
    							Swal.fire({
    								...
    								Swal.fire({
										title: '',
    									html: `Oh iya coba klik ikon hati yang di bawah ya (◡ ω ◡)`,
